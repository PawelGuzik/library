...
public class CategoryServicesUTest {
	...
	public void addCategoryWithLongName() {
		addCategoryWithInvalidName("This is catehory with wery long name that will cause exception.");
	}
	...
	@Test
	public void updeteWithNullName() {
		updateCategoryWithInvalidName(null);
	}

	@Test
	public void updeteWithShortName() {
		updateCategoryWithInvalidName("A");
	}

	@Test
	public void updeteWithLongName() {
		updateCategoryWithInvalidName("This is category with wery long name that will cause exception.");
	}
	...
	private void updateCategoryWithInvalidName(String name) {
		try {
			...
			fail("An exception should heve been thrown");
		} catch (FieldNotValidException e) {
			assertThat(e.getFieldName(), is(equalTo("name")));
